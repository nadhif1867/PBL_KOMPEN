...
<head>
    ...
    <script data-cfasync="false" nonce="1fb9bbdb-ab2a-4107-95ba-6760e0873032">
        try {
            (function(w, d) {
                ! function(j, k, l, m) {
                    if (j.zaraz) console.error("zaraz is loaded twice");
                        ...
                        j.zaraz._v = "5821";
                        j.zaraz._n = "1fb9bbdb-ab2a-4107-95ba-6760e0873032";
                        j.zaraz.q = [];
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <p class="mb-0">
                    Belum punya akun? <a href="register.html" class="text-center">Register</a>
                </p>
            </div>
            <!-- /.card-body -->
        </div>
